...
class _LumpsumCalculatorState extends State<LumpsumCalculator> {
  ...
  final TextEditingController _lumpsumInvestmentController = TextEditingController();
  ...
  void calculateLumpsum() {
    ...
    double lumpsumInvestment = double.tryParse(_lumpsumInvestmentController.text) ?? 0.0;
